...
def generate():
    ...
    final_index = final_index.replace("{{keywords}}", "hearing aids for veterans, VA benefits, audiology, tinnitus, military hearing loss")
    ...
    final_search = final_search.replace("{{keywords}}", "search, hearing aids, veterans, articles")
    ...
    for slug, data in PAGES.items():
        ...
        final_page = final_page.replace("{{keywords}}", f"{data['title'].lower()}, hearing aids for veterans, VA benefits")
    ...
    for art in ARTICLES:
        ...
        final_art = final_art.replace("{{keywords}}", f"{art['keyword']}, {cat_title.lower()}, hearing aids, veterans, VA benefits")
    ...
    for cat_slug, cat_data in CATEGORIES.items():
        ...
        final_cat = final_cat.replace("{{keywords}}", f"{cat_data['title'].lower()}, hearing aids, veterans, VA benefits")
